<template>
  ...
  >
    ...
    <div class="relative overflow-hidden aspect-[3/4]">
      ...
      <!-- Wishlist -->
      <button
        class="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md opacity-0 group-hover:opacity-100 transition hover:scale-110"
      >
