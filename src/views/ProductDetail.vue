      ...
      <div class="grid md:grid-cols-2 gap-10">
        ...
        <div class="py-4">
          ...
          <div class="flex gap-3">
            ...
            <button class="w-14 h-14 border rounded-xl flex items-center justify-center hover:border-red-400 hover:text-red-400 transition" :class="DarkMode.isDark ? 'border-gray-600' : 'border-gray-300'">
